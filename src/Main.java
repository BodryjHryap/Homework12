public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("sergeyEsenin.getAuthorName() = " + sergeyEsenin.getAuthorName());

        Book warAndPeace = new Book("Война и мир", levTolstoy, 1867);
        System.out.println("warAndPeace.getBookName() = " + warAndPeace.getBookName());
        System.out.println("warAndPeace.getAuthorName() = " + warAndPeace.getAuthorName().getAuthorName());
        ...
        System.out.println("blackHuman.getAuthorName() = " + blackHuman.getAuthorName().getAuthorName());
